...
[JA]
（1〜3の韓国語の内容をすべて省略せずに日本語に翻訳する。質問や指摘も含めてすべて訳す）
[/JA]
...
export default function App() {
  ...
  const [sideTab,         setSideTab]        = useState("vocab"); // "vocab" | "history"
...
const c = {
  ...
  /* Sidebar tabs */
  sideTabs:    { display: "flex", gap: 4, marginBottom: 8, flexShrink: 0 },
